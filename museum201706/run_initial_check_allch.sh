...
foreach ICHIP( ${CHIP_LIST} )
    ...
    # <Slow Control>
    ./make_control ${BOARD} ${CTRL_CHIP} ${CHANNEL} LLLLL${CTRL_DAC_BIT}LLHLH LLLLL${CTRL_DAC_BIT}LLHLH # default (last 3 bits are digital-output/analog-monitor/test-pulse-in)
