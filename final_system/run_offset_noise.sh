...
# <Slow Control>
./make_control ${BOARD} ${CTRL_CHIP} ${CHANNEL} ${CYCLE_CHANNEL} LLLLL${CTRL_DAC_BIT}LLHHH LLLLL${CTRL_DAC_BIT}LLLLL # default (last 3 bits are digital-output/analog-monitor/test-pulse-in)
