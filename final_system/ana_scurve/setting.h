...
Int_t   t_dac;
Int_t   t_tpchip;
Int_t   t_tpchip_cycle;
Int_t   t_tpchannel;
Int_t   t_tpchannel_cycle;
...
Int_t set_readbranch_scan( TChain* tree ){
  ...
  tree->SetBranchAddress("tpchip_cycle",    &t_tpchip_cycle     );
  tree->SetBranchAddress("tpchannel",       &t_tpchannel        );
  tree->SetBranchAddress("tpchannel_cycle", &t_tpchannel_cycle  );
  tree->SetBranchAddress("tpboard",         &t_tpboard_v        );
  tree->SetBranchAddress("vref",            &t_vref_v           );
