...
set FILE_LIST = `ls ../data/20170202_duringBT/raw_root_data/output*.root`
#set FILE_LIST = `ls ../data/20170308_tot/root_data/output*.root`
#set FILE_LIST = `ls ../data/20170315_tot/root_data/output*.root`
